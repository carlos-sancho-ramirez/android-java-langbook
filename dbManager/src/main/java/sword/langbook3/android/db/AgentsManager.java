...
public interface AgentsManager<LanguageId, AlphabetId, CorrelationId> extends BunchesManager<LanguageId, AlphabetId, CorrelationId>, AgentsChecker<LanguageId, AlphabetId, CorrelationId> {
