...
public interface QuizzesChecker<LanguageId, AlphabetId, CorrelationId, CorrelationArrayId, AcceptationId> extends AgentsChecker<LanguageId, AlphabetId, CorrelationId, CorrelationArrayId, AcceptationId> {
