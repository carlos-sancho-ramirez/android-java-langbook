...
public class LangbookDatabaseManager<ConceptId extends ConceptIdInterface, LanguageId extends LanguageIdInterface<ConceptId>, AlphabetId extends AlphabetIdInterface<ConceptId>, CharacterId, SymbolArrayId extends SymbolArrayIdInterface, CorrelationId extends CorrelationIdInterface, CorrelationArrayId extends CorrelationArrayIdInterface, AcceptationId extends AcceptationIdInterface, BunchId extends BunchIdInterface<ConceptId>, BunchSetId extends BunchSetIdInterface, RuleId extends RuleIdInterface<ConceptId>, AgentId extends AgentIdInterface, QuizId extends QuizIdInterface, SentenceId extends SentenceIdInterface> extends LangbookDatabaseChecker<ConceptId, LanguageId, AlphabetId, CharacterId, SymbolArrayId, CorrelationId, CorrelationArrayId, AcceptationId, BunchId, BunchSetId, RuleId, AgentId, QuizId, SentenceId> implements LangbookManager<ConceptId, LanguageId, AlphabetId, CharacterId, SymbolArrayId, CorrelationId, CorrelationArrayId, AcceptationId, BunchId, BunchSetId, RuleId, AgentId, QuizId, SentenceId> {
    ...
    public LangbookDatabaseManager(Database db, ConceptSetter<ConceptId> conceptIdManager, ConceptualizableSetter<ConceptId, LanguageId> languageIdManager, ConceptualizableSetter<ConceptId, AlphabetId> alphabetIdManager, IntSetter<CharacterId> characterIdManager, IntSetter<SymbolArrayId> symbolArrayIdManager, IntSetter<CorrelationId> correlationIdSetter, IntSetter<CorrelationArrayId> correlationArrayIdSetter, IntSetter<AcceptationId> acceptationIdSetter, ConceptualizableSetter<ConceptId, BunchId> bunchIdSetter, BunchSetIntSetter<BunchSetId> bunchSetIdSetter, ConceptualizableSetter<ConceptId, RuleId> ruleIdSetter, IntSetter<AgentId> agentIdSetter, IntSetter<QuizId> quizIdSetter, IntSetter<SentenceId> sentenceIdSetter) {
        super(db, conceptIdManager, languageIdManager, alphabetIdManager, characterIdManager, symbolArrayIdManager, correlationIdSetter, correlationArrayIdSetter, acceptationIdSetter, bunchIdSetter, bunchSetIdSetter, ruleIdSetter, agentIdSetter, quizIdSetter, sentenceIdSetter);
    }
    ...
    private ApplyResult<AlphabetId, CorrelationId> applyMatchersAddersAndConversions(
            ...
            AgentRegister<CorrelationId, CorrelationArrayId, BunchSetId, RuleId> register, AgentDetails<AlphabetId, CorrelationId, BunchId, RuleId> details, ImmutableMap<AlphabetId, AlphabetId> conversionMap,
    ...
    private void runAgent(AgentId agentId, AgentRegister<CorrelationId, CorrelationArrayId, BunchSetId, RuleId> register, AgentDetails<AlphabetId, CorrelationId, BunchId, RuleId> details) {
        ...
        if (!details.modifyCorrelations()) {
            ...
            for (AcceptationId acc : matchingAcceptations) {
                ...
                final ApplyResult<AlphabetId, CorrelationId> processResult = applyMatchersAddersAndConversions(correlationArrayResult.left, register, details, conversionMap, conversions::get, correlationArrayResult.right);
    ...
    public final AgentId addAgent(
        ...
        if (agentId != null) {
            ...
            runAgent(agentId, register, details);
        }
        ...
        if (!ruleApplied) {
            ...
            for (AcceptationId acc : addedAcceptations.toImmutable()) {
                ...
                if (!isMatching && dynAcc != null) {
                    ...
                    final ImmutablePair<ImmutableCorrelationArray<AlphabetId>, ImmutableList<CorrelationId>> correlationArrayResult = getAcceptationCorrelationArrayWithText(acc);
                    final ApplyResult<AlphabetId, CorrelationId> processResult = applyMatchersAddersAndConversions(correlationArrayResult.left, agentRegister, agentDetails, conversionMap, conversions::get, correlationArrayResult.right);
                    if (processResult != null) {
                        final ImmutableCorrelationArray<AlphabetId> modifiedCorrelationArray = processResult.correlationArray;
    ...
    private void rerunAgentForChangedConversion(AgentId agentId, Conversion<AlphabetId> newConversion) {
        ...
        if (!ruleApplied) {
            ...
            for (AcceptationId acc : matchingAcceptations.filterNot(alreadyProcessedAcceptations::contains)) {
                final ImmutablePair<ImmutableCorrelationArray<AlphabetId>, ImmutableList<CorrelationId>> correlationArrayResult = getAcceptationCorrelationArrayWithText(acc);
                final ApplyResult<AlphabetId, CorrelationId> processResult = applyMatchersAddersAndConversions(correlationArrayResult.left, register, agentDetails, conversionMap, conversions, correlationArrayResult.right);
