...
/**
 * Transforms a database query into a sqlite database query.
 *
 * This is a copy from the sword.langbook3.android.sqlite.SQLiteDbQuery class in the app package.
 * Both classes should be centralised if required.
 */
