...
public final class AddAlphabetMatchingBunchesPickerController implements MatchingBunchesPickerActivity.Controller, Fireable {
    ...
    public AddAlphabetMatchingBunchesPickerController(
        ...
        ensureNonNull(alphabetLanguage, correlation, correlationArray);
    ...
    public static final Creator<AddAlphabetMatchingBunchesPickerController> CREATOR = new Creator<AddAlphabetMatchingBunchesPickerController>() {
        ...
        public AddAlphabetMatchingBunchesPickerController createFromParcel(Parcel source) {
            ...
            return new AddAlphabetMatchingBunchesPickerController(alphabetLanguage, correlation, correlationArray);
        }
