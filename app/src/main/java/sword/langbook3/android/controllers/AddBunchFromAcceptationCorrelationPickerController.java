...
public final class AddBunchFromAcceptationCorrelationPickerController implements CorrelationPickerActivity.Controller, Fireable {
    ...
    public AddBunchFromAcceptationCorrelationPickerController(
        ...
        ensureNonNull(acceptationToBeIncluded, texts);
