...
public final class LinkAcceptationAcceptationConfirmationController implements AcceptationConfirmationActivity.Controller {
    ...
    public void confirm(@NonNull Presenter presenter) {
        presenter.openLinkageMechanismSelector(AcceptationConfirmationActivity.REQUEST_CODE_NEXT_STEP, new LinkAcceptationLinkageMechanismSelectorController(_sourceAcceptation, _targetAcceptation));
    }

    @Override
    public void onActivityResult(@NonNull Activity activity, int requestCode, int resultCode, Intent data) {
        if (requestCode == AcceptationConfirmationActivity.REQUEST_CODE_NEXT_STEP && resultCode == RESULT_OK) {
