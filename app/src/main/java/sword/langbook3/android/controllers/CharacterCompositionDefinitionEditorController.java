...
public final class CharacterCompositionDefinitionEditorController implements CharacterCompositionDefinitionEditorActivityDelegate.Controller {
    ...
    public void save(@NonNull ActivityExtensions activity, @NonNull CharacterCompositionDefinitionRegister register) {
        if (DbManager.getInstance().getManager().updateCharacterCompositionDefinition(_id, register)) {
            ...
            activity.showToast(R.string.updateCharacterCompositionDefinitionError);
        }
    }
