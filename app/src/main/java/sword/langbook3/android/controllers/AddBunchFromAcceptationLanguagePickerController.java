...
public final class AddBunchFromAcceptationLanguagePickerController implements LanguagePickerActivity.Controller, Fireable {
    ...
    private void complete(@NonNull Presenter presenter, int requestCode, @NonNull LanguageId language) {
        final WordEditorActivity.Controller controller = new AddBunchFromAcceptationWordEditorController(_acceptationToBeIncluded, language, _searchQuery);
