...
public final class AddAlphabetCorrelationPickerController implements CorrelationPickerActivity.Controller, Fireable {
    ...
    public AddAlphabetCorrelationPickerController(
        ...
        ensureNonNull(alphabetLanguage, texts);
