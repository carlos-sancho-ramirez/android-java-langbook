...
public final class DbUpdateQuery {
    ...
    private DbUpdateQuery(DbTable table, ImmutableIntPairMap constraints, ImmutableIntPairMap values) {
        _table = table;
        _constraints = constraints.map(DbIntValue::new);
        _values = values.map(DbIntValue::new);
    }
    ...
    public static final class Builder {
        ...
        public DbUpdateQuery build() {
            ...
            return new DbUpdateQuery(_table, _constraints.toImmutable(), _values.toImmutable());
        }
    }
}
