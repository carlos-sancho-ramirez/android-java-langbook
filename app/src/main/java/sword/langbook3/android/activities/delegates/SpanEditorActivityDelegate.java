...
import sword.langbook3.android.SpanEditorAdapter;
...
public final class SpanEditorActivityDelegate<Activity extends ActivityExtensions> extends AbstractActivityDelegate<Activity> implements ActionMode.Callback {
    ...
    private SpannableString getRichText() {
        ...
        final int highlightColor = _activity.getResources().getColor(R.color.agentDynamicTextColor);
    ...
    public void onCreate(@NonNull Activity activity, Bundle savedInstanceState) {
        ...
        activity.setContentView(R.layout.span_editor_activity);
        ...
        _sentenceText = activity.findViewById(R.id.sentenceText);
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        _activity.getMenuInflater().inflate(R.menu.span_editor_selection_actions, menu);
        return true;
    }
    ...
    public boolean onCreateOptionsMenu(@NonNull Activity activity, Menu menu) {
        activity.getMenuInflater().inflate(R.menu.span_editor, menu);
        return true;
    }
    ...
    public void onActivityResult(@NonNull Activity activity, int requestCode, int resultCode, Intent data) {
        _controller.onActivityResult(activity, requestCode, resultCode, data, new InnerState());
    }
    ...
    public interface Controller extends Parcelable {
        ...
        void pickAcceptation(@NonNull Presenter presenter, @NonNull Controller.MutableState state, @NonNull String query);
